        ...
        <div class="grid md:grid-cols-2 gap-4 items-center md:max-h-[475px] overflow-hidden">
            <div class="p-6">
                ...
                <p class="mt-4 text-sm font-semibold leading-9 text-black">Lorem ipsum dolor sit amet, consectetur
                    ...
                    accumsan, nuncet
                    tempus blandit, metus mi consectetur nibh, a pharetra felis turpis vitae ligula. Etiam laoreet velit nec
                    neque
                    ultrices, non consequat mauris tincidunt.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
                    accumsan, nuncet
            ...
            <div id="default-carousel" class="relative w-full" data-carousel="slide">
                ...
                <div class="relative h-56 overflow-hidden md:h-96">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://readymadeui.com/team-image.webp" class="object-cover w-full h-full shrink-0" />
                    </div>
                    <!-- Item 2 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://readymadeui.com/team-image.webp" class="object-cover w-full h-full shrink-0" />
                        ...
                        <div class="px-4 py-3 bg-gray-100">
                            <form action="">
                                ...
                                <div class="pt-1 mt-2 text-right">
                                    <button type="button" class="px-4 py-2 mr-2 text-white bg-[#24B49A] rounded-md">Post comment</button>
                                    <button type="button"
