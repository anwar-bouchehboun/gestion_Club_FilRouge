    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 ">
        ...
        <div>
            ...
            <ul class="space-y-4">
                ...
                <li>
                    <a href="javascript:void(0)" class=" text-white text-[15px] font-normal transition-all">ALL CLUB
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)" class=" text-white text-[15px] font-normal transition-all">ABOUT US
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)" class=" text-white text-[15px] font-normal transition-all">CONTACT
                        US</a>
                </li>
            </ul>
        </div>
...
<div class="border-t text-center bg-[#262626]  py-2 flex flex-wrap justify-evenly">
    <div class="text-white text-[15px] font-semibold">
        © 2024 - PHOENIX - CLUB.
        All Rights Reserved.
    </div>
    <div class="text-white text-[15px] font-semibold flex gap-5">
        <div>
