<div class=" md:my-16">
    <div class="font-sans text-[#333] max-w-6xl max-md:max-w-md mx-auto">
        <div class="grid md:grid-cols-2 items-center md:gap-12 gap-6">
          <div class="max-md:order-1 max-md:text-center z-50 relative">
            <h2 class="lg:text-6xl md:text-5xl text-3xl font-extrabold mb-4 md:!leading-[56px]"><span class="text-[#24B49A]">Multiple</span> Clubs <span class="text-[#24B49A]">and</span> Categories</h2>
            <p class="mt-6 text-base leading-relaxed">A club that brings together members interested in common activities, goals, and interests</p>
            <button type='button'
              class="bg-[#24B49A]  border-2 border-[#24B49A] mt-10 transition-all text-black font-bold text-sm rounded-md px-6 py-2.5">Learn More</button>
            {{-- <div class="mt-10">
          ...
          <div class="lg:h-[550px] md:h-[650px] flex items-center relative max-md:before:hidden before:absolute  before:h-[120%] before:w-[120%] before:right-0 before:z-0">
            <img src="./storage/image/logo.png" class="rounded-md lg:w-4/5 z-50 relative" alt="Logo club" />
          </div>
        </div>
        <div class="grid md:grid-cols-3 gap-4 z-50 relative md:px-4 max-md:mt-10">
          <div class="bg-white p-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-4 inline-block bg-[#24B49A] p-3 rounded-md" viewBox="0 0 32 32">
          ...
          <div class="bg-white p-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-4 inline-block bg-[#24B49A] p-3 rounded-md" viewBox="0 0 512.001 512.001">
          ...
          <div class="bg-white p-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-4 inline-block bg-[#24B49A] p-3 rounded-md" viewBox="0 0 24 24">
