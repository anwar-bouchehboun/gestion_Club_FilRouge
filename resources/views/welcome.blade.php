<x-home-layout>
    ...
    <x-slot name='solt'>
        ...
        <section class="my-3 md:my-10">
            <h2 class="text-2xl font-bold uppercase md:text-4xl md:ms-12 ms-3">Services</h2>
            <hr class="w-20 h-1 bg-black ms-3 md:mb-1 mb-9 md:ms-12 md:mb-10">
            ...
            <div class="relative z-50 flex flex-wrap gap-4 md:flex-row md:px-4 max-md:mt-10 justify-evenly">
                ...
                <div class="p-6 text-center border-[#24B49A] border-2 rounded shadow bg-hite border-spacing-48 w-52">
                    ...
                    <h3 class="mb-2 text-xl font-bold uppercase">Customization</h3>
                ...
                <div class="p-6 text-center border-[#24B49A] border-2  rounded shadow bg-hite border-spacing-48 w-52">
                    ...
                    <h3 class="mb-2 text-xl font-bold uppercase">Support</h3>
                ...
                <div class="p-6 text-center border-[#24B49A] border-2  rounded shadow bg-hite border-spacing-48 w-52">
                    ...
                    <h3 class="mb-2 text-xl font-bold uppercase">Performance</h3>
                ...
                <div class="p-6 text-center border-[#24B49A] border-2  rounded shadow bg-hite border-spacing-48 w-52">
                    ...
                    <h3 class="mb-2 text-xl font-bold uppercase">security</h3>
